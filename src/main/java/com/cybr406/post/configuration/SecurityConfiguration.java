...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    @Autowired
    private void configureGlobal(AuthenticationManagerBuilder authenticationManagerBuilder, AccountAuthenticationProvider accountAuthenticationProvider) throws Exception
        {
